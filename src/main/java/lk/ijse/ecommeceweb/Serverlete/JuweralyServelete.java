...
@WebServlet( name = "JuweralyServelete", value = "/juweraly")
public class JuweralyServelete extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                System.out.println(id + catagoryId + productName + description + quantity + price + url + "servelete");
